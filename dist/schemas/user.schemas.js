...
exports.UpdateUserSchema = exports.UsersQuerySchema = exports.UsersParamsSchema = exports.RoleSchema = exports.Roles = void 0;
const z = __importStar(require("zod"));
exports.Roles = ['user', 'admin'];
exports.RoleSchema = z.enum(exports.Roles);
exports.UsersParamsSchema = z
    .object({
    id: z
        .string()
})
    .strict();
exports.UsersQuerySchema = z
    .object({
